      ...
      cards: [
        ...
        },
        {
          ...
          list: [
            ...
            "Customer Service Certificate from Ajman University",
          ],
        },
      ],
    },
      ...
      cards: [
        ...
        },
        {
          ...
          list: [
            ...
            "شهادة خدمة العملاء من جامعة عجمان",
          ],
        },
      ],
    },
...
function updateContent() {
  ...
  mobileLinks[1].textContent = t.nav.certifications
  mobileLinks[2].textContent = t.nav.testimonials
  ...
  const certTitle = document.querySelector(".section-title")
  const certSubtitle = document.querySelector(".cert-subtitle")
  const certCards = document.querySelectorAll(".cert-premium-card")
